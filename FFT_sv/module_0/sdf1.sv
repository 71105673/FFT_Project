module sdf1 #(
    ...
    logic signed [12:0] bf2_rod_sign_re[0:15];
    logic signed [12:0] bf2_rod_sign_im[0:15];
    ...
    always_comb begin
        for (int i = 0; i < 16; i++) begin
            case (fac8_1_sel)
                ...
                2'd1: begin
                    bf2_rot_re[i] = bf2_sign_im[i] * 9'sd256;
                    bf2_rot_im[i] = -bf2_sign_re[i] * 9'sd256;
                end
                2'd2: begin
    ...
    always_comb begin
        ...
        for (int i = 0; i < 16; i++) begin
            ...
            re_tmp = bf2_rot_re[i] + 13'sd64;
            im_tmp = bf2_rot_im[i] + 13'sd64;
    ...
    always_comb begin
        for (int i = 0; i < 16; i++) begin
            if (rod1_sign_en) begin
                bf2_rod_sign_re[i] = -bf2_rod_re[i];
                bf2_rod_sign_im[i] = -bf2_rod_im[i];
            end else begin
                bf2_rod_sign_re[i] = bf2_rod_re[i];
                bf2_rod_sign_im[i] = bf2_rod_im[i];
            end
    ...
    butterfly #(
        ...
        .in_en (bf2_out_en),
        .out_en(bf3_out_en),
        .x0_re (bf2_rod_sign_re),
        .x0_im (bf2_rod_sign_im),
        .x1_re (sr3_out_re),
        .x1_im (sr3_out_im),
        .y0_re (bf3_add_re),
        .y0_im (bf3_add_im),
    ...
    assign do_en = do_count_en; // do_count_en 신호를 do_en 출력으로 내보냄
