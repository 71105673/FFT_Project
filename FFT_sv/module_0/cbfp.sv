...
logic [4:0] comp_min_re0, comp_min_re1, comp_min_re2, comp_min_re3;
logic [4:0] comp_min_im0, comp_min_im1, comp_min_im2, comp_min_im3;
...
always_ff @(posedge clk or negedge rstn) begin
    if (~rstn) begin
        ...
        comp_min_im0 <= comp_do_im1;
    end else if (di_en && di_count[1:0] == 2'h1) begin
        comp_min_im1 <= comp_do_im1;
    end else if (di_en && di_count[1:0] == 2'h2) begin
        comp_min_im2 <= comp_do_im1;
    end else if (di_en && di_count[1:0] == 2'h3) begin
        comp_min_im3 <= comp_do_im1;
    end
end

// 4 to 1 comparator
comp_min comp_re2 (
    .din  ({comp_min_re0, comp_min_re1, comp_min_re2, comp_min_re3}),
    .dout (comp_do_re2)
);
comp_min comp_im2 (
    .din  ({comp_min_im0, comp_min_im1, comp_min_im2, comp_min_im3}),
    .dout (comp_do_im2)
);
...
assign shift_num = (min_value > 5'd12) ? min_value - 5'd12 : 5'd12 - min_value;
