...
// 2nd bf
logic signed [WIDTH:0]   bf2_y0_re[0:15];
logic signed [WIDTH:0]   bf2_y0_im[0:15]; 
logic signed [WIDTH:0]   bf2_sp_re[0:15];
logic signed [WIDTH:0]   bf2_sp_im[0:15]; 
logic                    bf2_sp_en;     
logic signed [WIDTH:0]   bf2_do_re[0:15]; // 2nd bf Output
logic signed [WIDTH:0]   bf2_do_im[0:15];
logic                    bf2_do_en;

// 3rd bf
logic signed [WIDTH:0]   bf3_y0_re[0:15];
logic signed [WIDTH:0]   bf3_y0_im[0:15]; 
logic signed [WIDTH:0]   bf3_sp_re[0:15];
logic signed [WIDTH:0]   bf3_sp_im[0:15]; 
logic                    bf3_sp_en;     
logic signed [WIDTH:0]   bf3_do_re[0:15]; // 3rd bf Output
logic signed [WIDTH:0]   bf3_do_im[0:15];
logic                    bf3_do_en;
