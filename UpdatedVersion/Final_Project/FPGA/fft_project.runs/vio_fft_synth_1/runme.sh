...
HD_PWD='D:/yubdirectory/fft_project/fft_project.runs/vio_fft_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_fft.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_fft.tcl
