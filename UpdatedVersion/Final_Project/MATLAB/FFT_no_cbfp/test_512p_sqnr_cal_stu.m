...
% mat_float_fft = fft(cos_float); % Matlab fft (Cosine, Floating-point)
 ...
 [fft_out_fixed, module2_out_fixed] = fft_fixed(fft_mode, ran_fixed); % Fixed-point fft (Random, fft)
