...
function [fft_out, module2_out] = fft_float(fft_mode, fft_in)
 ...
 bfly00_out1 = din(1:256) - din(257:512);
  ...
  save_table_single(bfly00_out1, 1,'bfly00_out1_float.txt' );


 bfly00_tmp = [bfly00_out0, bfly00_out1];

   save_table_single(bfly00_tmp, 1,'bfly00_float.txt' );
 ...
 save_table_single(bfly01_tmp, 1,'bfly01_tmp_float.txt' );
 ...
 for nn=1:512
  ...
  save_table_single(bfly01, 1,'bfly01_float.txt' );
 ...
 for kk=1:4
  for nn=1:64
   ...
   save_table_single(bfly02_tmp, 1,'bfly02_tmp_float.txt' );
 ...
 save_table_single(bfly02, 1,'bfly02_float.txt' );
 ...
 save_table_single(bfly10_tmp, 1,'bfly10_tmp_float.txt' );
 ...
 for kk=1:8
  ...
  save_table_single(bfly10, 1,'bfly10_float.txt' );
 ...
 for kk=1:16
  for nn=1:16
   ...
   save_table_single(bfly11_tmp, 1,'bfly11_tmp_float.txt' );
 ...
 for kk=1:8
  for nn=1:64
    ...
    save_table_single(bfly11, 1,'bfly11_float.txt' );
 ...
 for kk=1:32
  for nn=1:8
    ...
    save_table_single(bfly12_tmp, 1,'bfly12_tmp_float.txt' );
 ...
 for kk=1:8
  for nn=1:64
	bfly12((kk-1)*64+nn) = bfly12_tmp((kk-1)*64+nn)*twf_m1(nn);
     ...
     save_table_single(bfly12, 1,'bfly12_float.txt' );
 ...
 save_table_single(bfly20_tmp, 1,'bfly20_tmp_float.txt' );
 ...
 for kk=1:64
  ...
  save_table_single(bfly20, 1,'bfly20_float.txt' );
 ...
 for kk=1:128
  for nn=1:2
   ...
   save_table_single(bfly21_tmp, 1,'bfly21_tmp_float.txt' );
 ...
 for kk=1:64
  for nn=1:8
    ...
    save_table_single(bfly21, 1,'bfly21_float.txt' );
 ...
 for kk=1:256
	...
	bfly22_tmp((kk-1)*2+2) = bfly21((kk-1)*2+1) - bfly21((kk-1)*2+2);
     ...
     save_table_single(bfly22_tmp, 1,'bfly22_tmp_float.txt' );
